...
class OrderServiceApplicationTests {
	...
	void whenPostRequestAndBookExistsThenOrderAccepted() throws IOException {
		...
		OrderAcceptedMessage message = objectMapper.readValue(payload, OrderAcceptedMessage.class);
		assertThat(message).isEqualTo(new OrderAcceptedMessage(createdOrder.id()));
	}
